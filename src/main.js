...
app.config.globalProperties.rpcUrl = 'https://rpc.testnet.codex.storage'

app.use(createPinia())
app.use(router)
app.use(ethersPlugin, {
  // url: 'http://localhost:8545', // localhost
  // marketplaceAddress: "0xa85233C63b9Ee964Add6F2cffe00Fd84eb32338f" // localhost
  // tokenAddress: "0x5FbDB2315678afecb367f032d93F642f64180aa3" // localhost
})
...
app.use(testTokenPlugin, {
  ...
  address: '0x150493837F923E71Ad8289742Ae8f2Bd7a478964'
})
app.use(codexPlugin, {
